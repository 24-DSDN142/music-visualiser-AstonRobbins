...
function draw_one_frame(words, vocal, drum, bass, other, counter) {
  ...
  drawOscillatingGradient(); //big screen
  fill(20);
  ...
  turnOnBulbsInCirclePattern(25, 50, vocal, cWidth / 7, bass); //left screen bulbs circles
  turnOnBulbsInCirclePattern(25, 50, vocal, cWidth - cWidth / 7, bass); //right screen bulbs circles
  startDiagonalLineAnimation(25, 50, vocal, bass); //both small screen bulbs lines
